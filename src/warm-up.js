...
var vegetables = ['zuchinni', 'carrots', 'peas', 'brocolli', 'asparagus'];
...
var fruits = ['apples', 'bannanas', 'grapes', 'watermelon', 'raspberries', 'blueberries', 'pears'];
